    ...
    >
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-10 overflow-x-hidden">
        ...
        >
          ...
          {/* CONTENT */}
          <div className="px-4 md:px-12 pb-6 md:pb-12 relative">
            ...
            <div className="-mt-16 mb-6">
              ...
              <div
                className="w-24 h-24 md:w-32 md:h-32 border-4 flex items-center justify-center rounded-full shadow-2xl"
        ...
        {/* PROGRESS */}
        <div
          className="border p-5 md:p-10 rounded-[2rem]"
