...
export default function StreakPage() {
  ...
  return (
    ...
    >
      ...
      {/* MAIN */}
      <main className="flex-1 md:ml-64 p-4 md:p-5 overflow-x-hidden">
        ...
        {/* HEATMAP */}
        <div
          className="border rounded-2xl p-4 md:p-5 mb-5 w-full overflow-x-auto"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
            ...
            {rewards.map((reward, index) => (
              ...
              <div
                key={index}
                className="rounded-2xl p-4 md:p-5 border hover:scale-[1.01] transition-all duration-200"
