      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8">
        ...
        <header className="mb-8 flex items-center justify-between flex-wrap gap-4">
          ...
          <button
            ...
            className="px-6 py-3 min-h-[44px] font-bold rounded-xl hover:scale-[1.01] hover:shadow-xl active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#FF6B35] focus:ring-offset-2 flex items-center gap-2"
            style={{
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 min-h-[44px] font-bold flex items-center justify-center gap-2 hover:shadow-lg hover:scale-[1.01] active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#FF6B35] focus:ring-offset-2 rounded-xl"
                      style={{
                        backgroundColor: colors.secondary,
                        color: "#fff",
                      }}
