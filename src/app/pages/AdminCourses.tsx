...
export function AdminCourses() {
  ...
  return (
    <div className="bg-[#F8F7F4] text-[#1A1A2E] p-[40px] min-h-[calc(100vh-64px)] font-sans relative overflow-x-hidden">
      ...
      {/* TOOLBAR */}
      <div className="bg-white border border-[#E2E1F0] rounded-[14px] p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center flex-wrap gap-3 w-full lg:w-auto">
          ...
          <div className="relative w-full sm:w-[240px]">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-4 bg-white border border-[#E2E1F0] text-[#1A1A2E] text-[13px] font-medium rounded-lg outline-none focus:border-[#F59E0B] transition-colors"
            />
          </div>
          ...
          <select
            ...
            className="w-full sm:w-auto h-11 px-3 bg-white border border-[#E2E1F0] text-[#1A1A2E] text-[13px] font-semibold rounded-lg outline-none cursor-pointer focus:border-[#F59E0B]"
          >
        ...
        {isFiltersActive && (
          <button
            ...
            className="text-[13px] font-bold text-[#F59E0B] hover:text-[#D97706] hover:underline cursor-pointer border-none bg-transparent outline-none flex items-center gap-1.5 self-start lg:self-auto font-sans"
          >
            <X size={14} />
            Clear filters
          </button>
      ...
      {/* Helper highlighter and body wrapper */}
      {(() => {
        ...
        return paginatedCourses.length === 0 ? (
          <div className="p-8 bg-white border border-[#E2E1F0] rounded-[12px]">
            <EmptyState
              icon="🔍"
              ...
              <table className="w-full text-left border-collapse min-w-[900px]">
                <thead>
                  <tr className="bg-[#F8F7F4] border-b border-[#E2E1F0] text-[12px] text-[#6B6B80] font-bold uppercase tracking-wider h-[46px]">
                    ...
                    <th onClick={() => handleSort('title')} className="px-5 py-3.5 w-[380px] cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Course
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th onClick={() => handleSort('instructor')} className="px-5 py-3.5 cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Instructor
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th onClick={() => handleSort('level')} className="px-5 py-3.5 cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Level
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th onClick={() => handleSort('enrolled')} className="px-5 py-3.5 cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Enrolled
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th onClick={() => handleSort('rating')} className="px-5 py-3.5 cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Rating
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th onClick={() => handleSort('status')} className="px-5 py-3.5 cursor-pointer hover:text-[#1A1A2E] transition-colors">
                      <div className="flex items-center gap-1.5 select-none">
                        Status
                        <ArrowUpDown size={14} className="text-[#6B6B80]" />
                      </div>
                    </th>
                    <th className="px-5 py-3.5 text-right pr-6 text-[#6B6B80]">Actions</th>
                  </tr>
                </thead>
