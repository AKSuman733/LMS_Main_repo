    ...
    <div className="w-full max-w-6xl mx-auto space-y-16 py-8">
      ...
      <section className="text-center space-y-6">
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6">
          Learn with <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-brand-orange">Uptoskills AI Learning</span>
        </h1>
        ...
        <div className="pt-8">
          <Link 
            to={getStartedPath}
            className="px-8 py-4 bg-brand-orange hover:bg-brand-orange-dark text-white font-bold rounded-full text-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
          >
            Get Started Now
          </Link>
        </div>
      ...
      <section className="grid md:grid-cols-3 gap-8 pt-12">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 text-center">
          <div className="w-16 h-16 bg-orange-100 dark:bg-orange-900/50 rounded-full flex items-center justify-center mx-auto mb-6 text-brand-orange dark:text-brand-orange-light">
            <BookOpen size={32} />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 text-center">
          <div className="w-16 h-16 bg-teal-100 dark:bg-purple-900/50 rounded-full flex items-center justify-center mx-auto mb-6 text-brand-teal dark:text-brand-teal-light">
            <Star size={32} />
          </div>
