...
export function Button({
  ...
  const variantStyles = {
    primary: `h-[44px] px-5 rounded-lg border-none text-white bg-[#FF6B35] shadow-[0_2px_4px_rgba(255,107,53,0.25)] cursor-pointer
      hover:bg-[#E85520] hover:shadow-[0_6px_16px_rgba(255,107,53,0.35)]
      focus-visible:bg-[#E85520] focus-visible:ring-2 focus-visible:ring-[#FF6B35] focus-visible:ring-offset-2
      active:scale-[0.97] active:duration-100`,
      
    secondary: `h-[44px] px-5 rounded-lg border-2 border-white/40 text-white bg-transparent cursor-pointer
      hover:bg-[#FF6B35] hover:border-[#FF6B35] hover:shadow-[0_4px_12px_rgba(255,107,53,0.2)]
    ...
    success: `h-[44px] px-5 rounded-lg border-none text-[#0A0F1E] bg-[#00B5A5] font-bold cursor-pointer
      hover:bg-[#008F82] hover:shadow-[0_4px_12px_rgba(0,181,165,0.2)]
      focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00B5A5] focus-visible:ring-offset-2
      active:scale-[0.97] active:duration-100`,
      
    icon: `w-9 h-9 rounded-full border-none bg-white/5 text-gray-300 cursor-pointer
      hover:bg-[#FF6B35]/20 hover:text-[#FF6B35]
      focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B35] focus-visible:ring-offset-2
