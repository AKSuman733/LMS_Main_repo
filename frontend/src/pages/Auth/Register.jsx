...
>>>>>>> 9e1de81cd6878b26aed245c1ff99ddd4ff053383
                ...
                />
                {formData.confirmPassword.length > 0 && formData.confirmPassword === formData.password && <CheckCircle2 className="validation-icon success" size={18} aria-hidden="true" />}
                {formData.confirmPassword.length > 0 && formData.confirmPassword !== formData.password && <XCircle className="validation-icon error" size={18} aria-hidden="true" />}
                <button 
                  type="button" 
                  className="password-toggle"
