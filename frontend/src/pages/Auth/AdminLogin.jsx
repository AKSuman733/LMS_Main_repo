  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.user.role !== 'admin') {
        const errorMsg = 'Access denied. This login is for administrators only.';
  ...
  return (
    <div className="split-login-container">
      <div className="login-image-side">
        <img src={adminSideImg} alt="Admin Portal" className="side-img" />
        <div className="side-overlay">
          <div className="side-content">
            <ShieldCheck size={48} className="side-icon" />
            <h1>Admin Console</h1>
            <p>Secure access to the management dashboard. Oversee platform activities and system integrity.</p>
          </div>
        </div>
      </div>
      ...
      <div className="login-form-side">
        <div className="form-container-premium">
          ...
          <div className="login-header-premium">
            <h2>Welcome, Admin</h2>
            <p>{showOTP ? 'Verification required' : 'Enter your credentials to continue'}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form-premium">
            ...
            <button type="submit" className="submit-btn-premium admin-btn" disabled={loading || (showOTP && timer === 0)}>
              {loading ? (
