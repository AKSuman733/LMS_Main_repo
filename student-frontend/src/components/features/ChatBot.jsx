...
export default function ChatBot() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className={`fixed z-[999] flex overflow-hidden border border-[#ffb8bb]/30 bg-white text-slate-900 shadow-[0_20px_80px_rgba(255,90,95,0.28)] transition-all duration-300
          ${
            minimized
              ? "bottom-6 right-6 h-[86px] w-[360px] rounded-[28px]"
              : "bottom-6 right-6 h-[640px] w-[420px] rounded-[32px] flex-col"
          }
          max-sm:bottom-0 max-sm:right-0 max-sm:h-[100dvh] max-sm:w-full max-sm:rounded-none`}
        >
          <div className="relative shrink-0 overflow-hidden bg-[#ff5a5f] px-5 py-5 text-white">
