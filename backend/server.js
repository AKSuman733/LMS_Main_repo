    ...
    try {
        ...
        await pool.query(`
            CREATE TABLE IF NOT EXISTS users (
                ...
                selected_instructor_id INTEGER REFERENCES instructors(id) ON DELETE SET NULL,
...
// ==========================================
// GROUP 1: AUTHENTICATION & PROFILE APIs
// ==========================================
...
// ==========================================
// GROUP 2: ADMIN USER/STUDENT MANAGEMENT
// ==========================================
...
// ==========================================
// GROUP 4: ENROLLMENTS & COURSE PROGRESS APIs
// ==========================================
...
// ==========================================
// GROUP 5: STUDENT TASKS MANAGEMENT
// ==========================================
...
// ==========================================
// GROUP 8: INSTRUCTORS MANAGEMENT APIs
// ==========================================
...
// ==========================================
// GROUP 9: ANALYTICS STATS & REPORTS APIs
// ==========================================
