...
router.get('/export', authMiddleware, authController.exportUsers);
router.put('/archive/:id', authMiddleware, authController.archiveUser);
router.put('/bulk-archive', authMiddleware, authController.bulkArchiveUsers);
router.put('/restore/:id', authMiddleware, authController.restoreUser);
router.put('/bulk-restore', authMiddleware, authController.bulkRestoreUsers);

// Delete operations
router.delete('/:id', authMiddleware, authController.deleteUser);
router.post('/bulk-delete', authMiddleware, authController.bulkDeleteUsers);
