    ...
    >
      ...
      <main className="p-4 md:p-6 lg:p-10">
        ...
        {showNewStudents && (
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            <motion.div
              ...
              className="w-[95%] max-w-[700px] rounded-[2rem] p-4 md:p-8 border"
              style={{
                backgroundColor: colors.surface,
                borderColor: "rgba(255,255,255,0.08)",
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* LEFT */}
          <div
            className="lg:col-span-2 rounded-[2.5rem] border p-4 md:p-8"
            style={{
              backgroundColor: colors.surface,
              borderColor: "rgba(255,255,255,0.08)",
              boxShadow: shadows.md,
          ...
          >
            ...
            {/* CHART */}
            <div
              className="h-64 flex items-end gap-1 md:gap-2 px-2 md:px-4 overflow-x-auto"
              style={{
                borderColor: "rgba(255,255,255,0.08)",
              }}
            >
          ...
          {/* RIGHT */}
          <div
            className="rounded-[2.5rem] border p-8 md:p-8"
            style={{
              backgroundColor: colors.surface,
              borderColor: "rgba(255,255,255,0.08)",
              boxShadow: shadows.md,
